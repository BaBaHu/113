...
public:
	...
	//牌堆扑克
public:
	CPngImageEx						m_ImageHeapSingleV;					//图片资源	.. 水平
	CPngImageEx						m_ImageHeapSingleH;					//图片资源	单张显示.. 垂直
	CPngImageEx						m_ImageHeapDoubleV;					//图片资源 ... 水平显示
	CPngImageEx						m_ImageHeapDoubleH;					//图片资源 两张麻将重叠起来 显示的背面 垂直显示
...
public:
	...
	//设置扑克  wCardCount=牌的数量，bCurrentCard=正要出牌的数量
